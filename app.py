...
@app.before_request
def add_user_to_g():
    # If were logged in, add current user to Flask global.
...
def logout():
    ...
    do_logout()
    flash('You are logged out. Goodbye!', 'success')
...
def profile():
    ...
    if form.validate_on_submit():
        ...
        flash("Incorrect password, please re-enter your login credentials.", "danger")
